...
Behind Supplementary Tables 7 and 8, Supplementary Note 5, and the upper row
of Figure 4. Everything here is read from a released file or from a
...
def main():
    print('=' * 96)
    print('SUPPLEMENTARY TABLE 7   five measured coordinative structures')
    print('=' * 96)
    print(f'{"system":<20}{"N":>5}{"H":>10}{"log2 N":>10}{"J":>9}{"2^H":>10}'
          f'{"hub %":>8}{"uniform %":>11}')
    for r in table_measured():
    ...
    print()
    print('=' * 96)
    print('SUPPLEMENTARY TABLE 8   outcome entropy in the expertise data')
    print('=' * 96)
    t = table_expertise()
    ...
    print()
    print('   The mean absolute error column of Supplementary Table 8 is not derived')
    ...
    print('   recorded in Supplementary Note 5.')

    print()
    print('=' * 96)
    print('SUPPLEMENTARY NOTE 4   the cortical threshold sweep')
    print('=' * 96)
