"""s1. The simulated ensembles behind Table 1, Figure 3 and SI Tables S1 to S5.
...
def main():
    ...
    print('=' * 96)
    print('TABLE 1 and SI TABLE S1   N = 100, mean degree 6, seeds 42 to 141')
    print('=' * 96)
    rows = table_1()
    ...
    print()
    print('SI TABLE S2   control entropy across network size, mean degree 6')
    ...
    print()
    print('SI TABLE S3   control entropy across mean degree, N = 100')
    ...
    print()
    print('SI TABLE S4   the two coupling weightings, N = 100')
    ...
    print()
    print('SI SECTION 3   bootstrap intervals and the separation')
    ...
    print()
    print('SI TABLE S5   five-fold accuracy from a single feature, four classes')
    try:
        table_s5(ens)
    except ImportError:
