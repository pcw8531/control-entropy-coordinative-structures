...
The values printed in the current Supplementary Table 6 come from the bare form.
The three
...
def main():
    print('=' * 104)
    print('SUPPLEMENTARY TABLE 6   sixty realisations per cell, seeds 42 to 101')
    print('=' * 104)
    for name, N, kmean, measured in ROWS:
        ...
        print(f'    {"scale-free":<14} {bm:>8.4f} +/- {bsd:.4f}'
              ...
              f'the value currently printed in Supplementary Table 6')
